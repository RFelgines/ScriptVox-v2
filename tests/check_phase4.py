...
# NOTE (audit 2026-07-02, Lot C1) : la section "_synthesise_book() synthesises all
# segments and assembles WAV" a été retirée -- _synthesise_book n'existe plus
# (génération livre unifiée sur le chemin chapitre). Couverture équivalente,
# via le point d'entrée public _generate_book_impl, dans tests/check_phase27.py
# section 2 (happy path 2 chapitres -> book.wav assemblé depuis le disque).
